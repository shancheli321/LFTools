...
import com.lf.ui.layout.helper.RCAttrs;
import com.lf.ui.layout.helper.RCHelper;


/**
 * @date: 2024/7/24
 */
public class LFRectRelativeLayout extends RelativeLayout implements Checkable, RCAttrs {
    RCHelper mRCHelper;

    public LFRectRelativeLayout(Context context) {
        this(context, null);
    }

    public LFRectRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LFRectRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
