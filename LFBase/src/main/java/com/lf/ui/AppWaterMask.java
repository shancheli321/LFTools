...
public class AppWaterMask {
    ...
    private class WatermarkDrawable extends Drawable {
        ...
        public void draw(@NonNull Canvas canvas) {
            ...
            mPaint.setTextSize(sp2px(mContext, mTextSize)); // ConvertUtils.spToPx()这个方法是将sp转换成px，ConvertUtils这个工具类在我提供的demo里面有
    ...
    public int sp2px(Context context, final float spValue) {
